                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> The Title
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                 The Sub Title
                                <span class="panel-desc"> The sub title for your post</span>
                            </h3>
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" id="title" name="sub_title" placeholder="Sub Title" value="@if(isset($dataTypeContent->sub_title)){{ $dataTypeContent->sub_title }}@endif">
                        </div>
                    </div>
                </div>
                    <!-- ### CONTENT ### -->
